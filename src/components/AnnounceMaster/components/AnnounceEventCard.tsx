    ...
    <div className="card card-flush h-xl-100">
      ...
      <div className="card-body pt-2">
        <div className="row g-5">
          ...
          <div className="col-md-2">
            <label className="form-label fw-semibold">Event Cause</label>
            <select
              className="form-select"
          ...
          <div className="col-md-3">
            <label className="form-label fw-semibold">Pandit Ji</label>
            <select
              className="form-select"
              value={form.panditJi}
          ...
          <div className="col-md-4">
            ...
            <select className="form-select form-select-solid" value={form.currency} disabled>

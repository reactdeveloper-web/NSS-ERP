                ...
                <table className="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4 dashboard-task-detail-table">
                  <thead>
                    <tr className="fw-bolder text-muted">
                      ...
                      <th className='width-22'>Employee Name</th>
                      <th className='width-18'>Store Name</th>
                      <th className='width-28'>Item Name</th>
                      <th className='width-12'>Mobile</th>
                      <th className='width-10'>RRS Type</th>
                    </tr>
                  </thead>
